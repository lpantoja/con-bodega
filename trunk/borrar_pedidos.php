...
echo"        <tr>";
echo"          <td width=\"122\" bordercolor=\"#004080\" bgcolor=\"#F9FFFF\"><span class=\"Estilo1\">Codigo Pedido</span></td>";
echo"          <td width=\"157\" bordercolor=\"#004080\" bgcolor=\"#F9FFFF\"><span class=\"Estilo1\">Numero de Items </span></td>";
...
{ 
	...
	$var2=odbc_result($result,"NUMERO_ITEMS");
	echo"          <td bordercolor=\"#004080\" bgcolor=\"#F9FFFF\">$var2</td>";
	echo"          <td bordercolor=\"#004080\" bgcolor=\"#F9FFFF\"><a href=\"borrar_pedidos_2.php?cod_pro=$var1&amp;nom_pro=$var2\" onclick=\"return confirmLink(this, 'Borrar el Pedido :  $var1  ')\"> <img hspace=\"7\" width=\"11\" height=\"13\" src=\"imagenes/button_drop.png\" alt=\"Eliminar\" title=\"Eliminar\" border=\"0\" /></td>";
	echo"        </tr>";
