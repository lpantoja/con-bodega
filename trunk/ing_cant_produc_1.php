...
<div style="width: 800px; position: relative; margin-left: auto; margin-right: auto; left: 0; top: 0;">
  ...
  <div id="Layer1">
    ...
    <div id="Layer3">
     <form  onSubmit="return valida(formulario)"  name="formulario" method="post" action="ing_cant_produc.php">
    ...
    <div id="Layer4">
	  <form  onSubmit="return valida(formulario2)"  name="formulario2" method="post" action="ing_cant_produc.php">
