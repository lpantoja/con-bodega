...
<div style="width: 800px; position: relative; margin-left: auto; margin-right: auto; left: 0; top: 0;">
  ...
  <div id="Layer1">
    <div class="Estilo1" id="Layer2">Ver datos  Pedido</div>
    <div id="Layer3">
     <form  onSubmit="return valida(formulario)"  name="formulario" method="post" action="ver_pedido_1.php">
    ...
    <div id="Layer4">
	  <form  onSubmit="return valida(formulario2)"  name="formulario2" method="post" action="ver_pedido_1.php">
        <table width="282" border="3" bordercolor="#004080" bgcolor="#F9FFFF">
          <tr>
            <td width="114" bordercolor="#004080" bgcolor="#F9FFFF"><div align="center" class="Estilo2">C&oacute;digo Pedido </div></td>
